...
import { browsejobfilterlistdata } from '../../constant/alldata';
		...
		<>
			...
			<div className="page-content bg-white">
				<div className="dez-bnr-inr overlay-black-middle" style={{ backgroundImage: `url(${IMAGES.bnr1})` }}>
					<PageTitle motherName="Home" activeName="Browse Job Filter List" />
				</div>
				<Jobfindbox />
									...
									<div className="job-bx-title clearfix">
										...
										<div className="float-end d-flex">
											...
											<div className="float-end p-tb5 p-r10">
												<Link to={"/browse-job-filter-list"} className="p-lr5"><i className="fa fa-th-list" /></Link>
												<Link to={"/browse-job-filter-grid"} className="p-lr5"><i className="fa fa-th text-black" /></Link>
											</div>
										</div>
									</div>
									<ul className="post-job-bx">
										{browsejobfilterlistdata.map((item, index) => (
											<li key={index}>
