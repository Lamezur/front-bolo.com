											...
											<div className="row">
												...
												<div className="col-lg-6">
													<div className="form-group dz-dropdown">
														...
														<Form.Select as="select" custom className="form-control">
												...
												<div className="col-lg-12">
													<div className="form-group">
														<div className="form-check">
															...
															<label className="form-check-label" htmlFor="job-alert-check">Also send me jobs closely related to my search terms </label>
														</div>
													</div>
												</div>
					...
					<div className="modal-dialog" role="document">
						<div className="modal-content">
							...
							<div className="modal-body row m-a0 clearfix">
								<div className="col-lg-6 col-md-6 overlay-primary-dark d-flex p-a0" style={{ backgroundImage: `url( ${IMAGES.bg3} )`, backgroundPosition: "center", backgroundSize: "cover" }}>
									<div className="form-info text-white align-self-center">
										...
										<ul className="list-inline m-a0">
											<li><Link to={"https://www.facebook.com/dexignzone"} className="m-r10 text-white"><i className="fa fa-facebook" /></Link></li>
											<li><Link to={"https://dexignzone.com/"} className="m-r10 text-white"><i className="fa fa-google-plus" /></Link></li>
											<li><Link to={"https://www.linkedin.com/showcase/dexignzone/posts/?feedView=all"} className="m-r10 text-white"><i className="fa fa-linkedin" /></Link></li>
											<li><Link to={"https://www.instagram.com/dexignzone"} className="m-r10 text-white"><i className="fa fa-instagram" /></Link></li>
											<li><Link to={"https://www.x.com/dexignzone"} className="m-r10 text-white"><i className="fa fa-twitter" /></Link></li>
										</ul>
									</div>
								</div>
