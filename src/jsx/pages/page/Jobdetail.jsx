...
import { blogGrid } from '../../constant/alldata';
										...
										<div className="row">
											...
											<div className="col-lg-12 col-md-6">
												<div className="widget bg-white p-lr20 p-t20  widget_getintuch radius-sm">
													...
													<ul>
														<li><i className="ti-location-pin" /> <strong className="font-weight-700 text-black">Address</strong><span className="text-black-light"> Demo Address #8901 Marmora Road Chi Minh City, Vietnam </span></li>
														<li><i className="ti-money" /> <strong className="font-weight-700 text-black">Salary</strong> $800 Monthy</li>
														<li><i className="ti-shield" /> <strong className="font-weight-700 text-black">Experience</strong>6 Year Experience</li>
													</ul>
												</div>
											</div>
										</div>
								...
								<div className="col-lg-8">
									<div className="job-info-box">
										...
										<ul className="job-info">
											...
											<li><strong>Deadline:</strong> 25th January 2025</li>
											<li><i className="ti-location-pin text-black m-r5" />  NewYark </li>
										</ul>
										...
										<div className="m-b30 blog-grid">
											...
											<div className="dez-info p-a20 border-1">
												...
												<div className="dez-post-meta ">
													<ul>
														<li className="post-date"> <i className="ti-location-pin" />  London </li>
														<li className="post-author"><i className="ti-user" /> By <Link to={"#"}>Jone</Link> </li>
													</ul>
												</div>
