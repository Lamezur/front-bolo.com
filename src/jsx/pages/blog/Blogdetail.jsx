		...
		<>
			...
			<div className="page-content bg-white">
				<div className="dez-bnr-inr overlay-black-middle" style={{ backgroundImage: `url(${IMAGES.bnr1})` }}>
					<PageTitle motherName="Home" activeName="Blog Details" />
				</div>
							...
							<div className="col-lg-8 col-md-7 m-b10">
								<div className="blog-post blog-single blog-style-1">
									...
									<div className="dez-post-media dez-img-effect zoom-slow m-t20">
										<Link to={"#"}><img src={IMAGES.blogthum1} alt="" /></Link>
									</div>
									<div className="dez-post-text">
										...
										<img className="alignleft blog-side-img" src={IMAGES.bloggrid4} alt="" />
										...
										<img className="alignright blog-side-img" src={IMAGES.bloggrid1} alt="" />
										<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text
											ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only
											five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release
											of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like
									...
									<div className="dez-divider bg-gray-dark op4"><i className="icon-dot c-square" /></div>
									<div className="share-details-btn">
										<ul>
											<li><h5 className="m-a0">Share Post</h5></li>
											<li><Link to={"https://www.facebook.com/dexignzone"} className="site-button facebook button-sm"><i className="fa fa-facebook" /> Facebook</Link></li>
											<li><Link to={"https://dexignzone.com/"} className="site-button google-plus button-sm"><i className="fa fa-google-plus" /> Google Plus</Link></li>
											<li><Link to={"https://www.linkedin.com/showcase/dexignzone/posts/?feedView=all"} className="site-button linkedin button-sm"><i className="fa fa-linkedin" /> Linkedin</Link></li>
											<li><Link to={"https://www.instagram.com/dexignzone/"} className="site-button instagram button-sm"><i className="fa fa-instagram" /> Instagram</Link></li>
											<li><Link to={"https://twitter.com/dexignzone"} className="site-button twitter button-sm"><i className="fa fa-twitter" /> Twitter</Link></li>
											<li><Link to={"https://www.whatsapp.com/"} className="site-button whatsapp button-sm"><i className="fa fa-whatsapp" /> Whatsapp</Link></li>
										</ul>
									</div>
								</div>
										...
										<div className="clearfix m-b20">
											<ol className="comment-list">
												<li className="comment">
													<div className="comment-body">
														<div className="comment-author vcard">
															<img className="avatar photo" src={IMAGES.testimonial1} alt="" /> 	<cite className="fn">Stacy poe</cite> <span className="says">says:</span>
														</div>
														<div className="comment-meta"> <Link to={"#"}>October 6, 2025 at 7:15 am</Link> </div>
													...
													<ol className="children">
														<li className="comment odd parent">
															<div className="comment-body">
																<div className="comment-author vcard"> <img className="avatar photo" src={IMAGES.testimonial2} alt="" /> <cite className="fn">Stacy poe</cite> <span className="says">says:</span> </div>
																<div className="comment-meta"> <Link to={"#"}>October 6, 2025 at 7:15 am</Link> </div>
															...
															<ol className="children">
																<li className="comment odd parent">
																	<div className="comment-body">
																		<div className="comment-author vcard"> <img className="avatar photo" src={IMAGES.testimonial3} alt="" /> <cite className="fn">Stacy poe</cite> <span className="says">says:</span> </div>
																		<div className="comment-meta"> <Link to={"#"}>October 6, 2025 at 7:15 am</Link> </div>
																		<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam vitae neque vitae sapien malesuada aliquet.
																			In viverra dictum justo in vehicula. Fusce et massa eu ante ornare molestie. Sed vestibulum sem felis,
																			ac elementum ligula blandit ac.</p>
												...
												<li className="comment">
													<div className="comment-body">
														<div className="comment-author vcard">
															<img className="avatar photo" src={IMAGES.testimonial1} alt="" /> <cite className="fn">Stacy poe</cite> <span className="says">says:</span> </div>
														<div className="comment-meta"> <Link to={"#"}>October 6, 2025 at 7:15 am</Link> </div>
														<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam vitae neque vitae sapien malesuada aliquet.
															In viverra dictum justo in vehicula. Fusce et massa eu ante ornare molestie. Sed vestibulum sem felis,
															ac elementum ligula blandit ac.</p>
												...
												<li className="comment">
													<div className="comment-body">
														<div className="comment-author vcard">
															<img className="avatar photo" src={IMAGES.testimonial2} alt="" /> <cite className="fn">Stacy poe</cite> <span className="says">says:</span> </div>
														<div className="comment-meta"> <Link to={"#"}>October 6, 2025 at 7:15 am</Link> </div>
														<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam vitae neque vitae sapien malesuada aliquet.
															In viverra dictum justo in vehicula. Fusce et massa eu ante ornare molestie. Sed vestibulum sem felis,
															ac elementum ligula blandit ac.</p>
												...
												<li className="comment">
													<div className="comment-body">
														<div className="comment-author vcard">
															<img className="avatar photo" src={IMAGES.testimonial3} alt="" /> <cite className="fn">Stacy poe</cite> <span className="says">says:</span> </div>
														<div className="comment-meta"> <Link to={"#"}>October 6, 2025 at 7:15 am</Link> </div>
														<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam vitae neque vitae sapien malesuada aliquet.
															In viverra dictum justo in vehicula. Fusce et massa eu ante ornare molestie. Sed vestibulum sem felis,
															ac elementum ligula blandit ac.</p>
