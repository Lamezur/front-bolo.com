	...
	return (
		<>
			...
			<div className="page-content">
				<div className="overlay-black-dark profile-edit p-t50 p-b20" style={{ backgroundImage: `url(${IMAGES.bnr1})` }}>
								...
								<div className="candidate-detail">
									...
									<div className="text-white browse-job text-left">
										<h4 className="m-b0">John Doe
											<Link to={"#"} onClick={() => setBasicDetails(true)} className="m-l15 font-16 text-white"><i className="fa fa-pencil" /></Link>
										</h4>
										<p className="m-b15">Freelance Senior PHP Developer at various agencies</p>
										<ul className="clearfix">
											<li><i className="ti-location-pin" /> Sacramento, California</li>
											<li><i className="ti-mobile" /> +1 123 456 7890</li>
											<li><i className="ti-briefcase" /> Fresher</li>
								...
								<div className="col-xl-9 col-lg-8 col-md-8 col-sm-12">
									<div id="resume_headline_bx" className=" job-bx m-b30">
										<div className="d-flex">
											...
											<Link to={"#"} className="site-button add-btn button-sm" onClick={() => setResume(true)}>
												<i className="fa fa-pencil m-r5" /> Edit
											</Link>
										</div>
												...
												<div className="modal-content">
													...
													<div className="modal-body">
														...
														<form>
															<div className="row">
																<div className="col-lg-12 col-md-12">
																	<div className="job-bx form-group" >
																		<textarea className="form-control border-0" placeholder="Type Description"></textarea>
																	</div>
																</div>
															</div>
														</form>
									...
									<div id="key_skills_bx" className="job-bx m-b30">
										<div className="d-flex">
											...
											<Link to={"#"} data-toggle="modal" data-target="#keyskills" onClick={() => setKeyskill(true)} className="site-button add-btn button-sm"><i className="fa fa-pencil m-r5" /> Edit</Link>
										</div>
										<div className="job-time me-auto">
											...
											<Link to={"#"} className="me-1"><span>Web Designing</span></Link>
											<Link to={"#"} className="me-1"><span>Photoshop</span></Link>
										</div>
												...
												<div className="modal-content">
													...
													<div className="modal-body">
														...
														<form>
															<div className="row">
																<div className="col-lg-12 col-md-12">
																	<div className="form-group  job-bx">
									...
									<div id="employment_bx" className="job-bx m-b30 ">
										<div className="d-flex">
											...
											<Link to={"#"} onClick={() => setEmployment(true)} className="site-button add-btn button-sm"><i className="fa fa-pencil m-r5" /> Edit</Link>
										</div>
									...
									<div id="education_bx" className="job-bx m-b30">
										<div className="d-flex">
											...
											<Link to={"#"} onClick={() => setEducation(true)} className="site-button add-btn button-sm"><i className="fa fa-pencil m-r5" /> Edit</Link>
										</div>
										...
										<table>
											...
											<tbody>
												<tr>
													...
													<td><Link to={"#"} className="m-l15 font-14" data-toggle="modal" data-target="#itskills" ><i className="fa fa-pencil" /></Link></td>
												</tr>
												<tr>
													<td>Bootstrap</td>
													<td>4</td>
									...
									<div id="projects_bx" className="job-bx m-b30">
										<div className="d-flex">
											...
											<Link to={"#"} onClick={() => setProjects(true)} className="site-button add-btn button-sm"><i className="fa fa-pencil m-r5" /> Edit</Link>
										</div>
													...
													<div className="modal-body">
														<form>
															<div className="row">
																...
																<div className="col-lg-12 col-md-12">
																	<div className="form-group job-bx dz-dropdown" >
											...
											<div className="list-line">
												...
												<div className="list-line">
													<div className="d-flex">
														...
														<Link to={"#"} onClick={() => setWhitePaper(true)} className="site-button add-btn button-sm"><i className="fa fa-pencil m-r5" /> Edit</Link>
													</div>
												...
												<div className="list-line">
													<div className="d-flex">
														...
														<Link to={"#"} onClick={() => setPresentation(true)} className="site-button add-btn button-sm"><i className="fa fa-pencil m-r5" /> Edit</Link>
													</div>
												...
												<div className="list-line">
													<div className="d-flex">
														...
														<Link to={"#"} data-toggle="modal" data-target="#patent" onClick={() => setPatent(true)} className="site-button add-btn button-sm"><i className="fa fa-pencil m-r5" /> Edit</Link>
													</div>
												...
												<div className="list-line">
													<div className="d-flex">
														...
														<Link to={"#"} onClick={() => setCertification(true)} className="site-button add-btn button-sm"><i className="fa fa-pencil m-r5" /> Edit</Link>
													</div>
									...
									<div id="desired_career_profile_bx" className="job-bx m-b30">
										<div className="d-flex">
											...
											<Link to={"#"} onClick={() => setCareerProfile(true)} className="site-button add-btn button-sm"><i className="fa fa-pencil m-r5" /> Edit</Link>
										</div>
									...
									<div id="personal_details_bx" className="job-bx m-b30">
										<div className="d-flex">
											...
											<Link to={"#"} onClick={() => setPersonalDetails(true)} className="site-button add-btn button-sm"><i className="fa fa-pencil m-r5" /> Edit</Link>
										</div>
													...
													<div className="form-group" >
														<div className="custom-file">
															<p className="m-auto align-self-center">
																<i className="fa fa-upload" />  Upload Resume File size is 3 MB
															</p>
