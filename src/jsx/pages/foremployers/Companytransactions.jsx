								...
								<div className="col-xl-9 col-lg-8 m-b30">
									<div className="job-bx table-job-bx clearfix">
										<div className="job-bx-title clearfix">
											...
											<Link to={"/company-post-jobs"} className="site-button right-arrow button-sm float-end">Back</Link>
										</div>
										<table>
											<thead>
												<tr>
											...
											<tbody>
												<tr>
													...
													<td className="date">Dec 15,2024</td>
												...
												<tr>
													...
													<td className="date">Nov 10,2024</td>
												...
												<tr>
													...
													<td className="date">Oct 5,2024</td>
													<td className="transfer">Paypal</td>
													<td className="expired pending">Pending </td>
												</tr>
												<tr>
