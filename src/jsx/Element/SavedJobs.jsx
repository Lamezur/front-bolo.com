					...
					<div className="">
						<form >
							...
							<div className="modal-body">
								<i className="flaticon-cancel-12 close" />
							...
							<div className="modal-footer">
								...
								<button type="button" onClick={() => setPostModal(false)} className="btn btn-danger"> <i className="flaticon-delete-1" /> Discard</button>
							</div>
						</form>
